      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="order-2 lg:order-1">
          ...
          <p className="text-neutral-400 mb-8 font-medium leading-relaxed">
            Drag the slider to see how we restore neglected paintwork to a mirror-like finish. 
            Our multi-stage correction process removes 99% of surface defects and restores 
            the deep, rich gloss your car deserves.
          </p>
        ...
        <div className="order-1 lg:order-2">
          <ImageSlider 
            beforeImg="https://images.unsplash.com/photo-1507136566006-bb41e85733f8?q=80&w=2059" 
            afterImg="https://images.unsplash.com/photo-1552519507-da3b142c6e3d?q=80&w=2070" 
          />
